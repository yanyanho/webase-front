 ...
 * the License.
 */
package com.miya.token.web3api;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.miya.token.base.enums.DataStatus;
import com.miya.token.web3api.entity.NodeStatusInfo;
import com.miya.token.web3api.entity.PeerOfConsensusStatus;
import com.miya.token.web3api.entity.PeerOfSyncStatus;
import com.miya.token.web3api.entity.SyncStatus;
import com.miya.token.base.ConstantCode;
import com.miya.token.base.FrontUtils;
import com.miya.token.base.exception.FrontException;
import com.miya.token.config.NodeConfig;
import com.miya.token.config.Web3Config;
...
public class Web3ApiService {
    ...
    public List<NodeStatusInfo> getNodeStatusList(int groupId) {
        ...
        try {
            ...
            com.miya.token.web3api.entity.SyncStatus syncStatus = JSON.parseObject(getSyncStatus(groupId), com.miya.token.web3api.entity.SyncStatus.class);
